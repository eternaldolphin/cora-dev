...
class CocoEvaluator(object):
    def __init__(self, coco_gt, iou_types, label2cat=None, args=None):
        ...
        if args.label_version == 'fewshot':
            ...
            self.base_catids = [1, 2, 3, 4, 5, 6, 7, 9, 16, 17, 18, 19, 20, 21, 44, 62, 63, 64, 67, 72]
        elif args.label_version == 'small_RN50base':
            self.base_catids = [\
                70, 53, 7, 73, 57, 79, 62, 74, 9, 38, 20, 19, 54, 85, \
                72, 27, 80, 51, 78, 15, 84, 55, 16, 59, 48, 34, 23, 86, 90, 50, \
                25, 31, 56, 82, 75, 42, 65, 52, 60, 35, 8, 44, 33, 24]
            self.target_catids = [1, 2, 3, 4, 28, 21, 47, 6, 76, 41, 18, 63, 32, 36, 81, 22, 61, 87, 5, 17, 49]
            ...
            self.base_catids = [\
                ...
                72, 27, 80, 51, 78, 15, 84, 55, 16, 59, 48, 34, 23, 86, 90, 50, \
                25, 31, 56, 82, 75, 42, 3, 65, 52, 60, 35, 8, 44, 33, 24]
            self.target_catids = [1, 28, 21, 47, 6, 76, 41, 18, 63, 32, 36, 81, 22, 61, 87, 5, 17, 49]
        else:
            self.base_catids = [\
                70, 2, 53, 7, 73, 57, 4, 79, 62, 74, 9, 38, 20, 19, 54, 85, \
                72, 27, 80, 51, 78, 15, 84, 55, 16, 59, 48, 34, 23, 86, 90, 50, \
